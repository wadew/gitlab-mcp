...
from gitlab_mcp.server import _get_tool_definitions, get_tool_annotations, TOOL_ANNOTATIONS
...
class TestAnnotationConsistency:
    ...
    def test_no_tool_is_both_destructive_and_readonly(self):
        ...
        for tool_name, annotation in TOOL_ANNOTATIONS.items():
            assert not (annotation["destructive"] and annotation["readOnly"]), (
